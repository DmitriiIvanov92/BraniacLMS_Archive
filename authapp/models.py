...
# gettext_lazy as _ - передача сообщения через псевдоним. Так же можно использовать gettext()
from django.utils.translation import gettext_lazy as _

# Для указания пути загрузки Аватарки:
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    #  Проверка на наличие Асик символов в юзернейм
